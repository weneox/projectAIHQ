...
function StatusPill({ status }) {
  ...
  return (
    ...
    >
      <span className={["h-2 w-2 rounded-md", live ? "bg-emerald-500" : "bg-text-subtle"].join(" ")} />
      {x || "unknown"}
    </div>
  );
}
...
function ControlButton({ icon: Icon, label, onClick, disabled = false, pending = false, tone = "neutral" }) {
  ...
  return (
    <button
      ...
      className={`inline-flex items-center justify-center gap-2 rounded-md border px-4 py-3 text-sm transition disabled:cursor-not-allowed disabled:opacity-45 ${toneClass}`}
    >
    ...
    <AdminPageShell
      ...
      actions={
        <button
          ...
          className="inline-flex items-center gap-2 rounded-md border border-brand/15 bg-brand-soft px-4 py-3 text-sm text-brand transition hover:border-brand/25 disabled:cursor-not-allowed disabled:opacity-45"
        >
    ...
    >
      ...
      <Surface className="space-y-5">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
          ...
          <div className="rounded-md border border-line bg-surface px-3 py-2 text-xs text-text-muted">
          ...
          <div className="flex flex-col gap-4 border-b border-line-soft pb-5 lg:flex-row lg:items-start lg:justify-between">
            <div className="min-w-0">
              <div className="mb-2 flex flex-wrap items-center gap-2">
                ...
                <div className="rounded-md border border-line bg-surface px-3 py-1 text-xs text-text-muted">
              ...
              <Surface className="space-y-3 border-brand/15 bg-brand-soft">
                ...
                <div className="space-y-3 text-sm text-text-muted">
                  ...
                  <button
                    ...
                    disabled={!selectedId || surface.saving || !selectedLive}
                    onClick={joinSelectedCall}
                    className="mt-2 inline-flex w-full items-center justify-center gap-2 rounded-md border border-brand bg-brand px-4 py-3 text-sm text-white transition hover:border-brand-strong hover:bg-brand-strong disabled:cursor-not-allowed disabled:opacity-45"
                  >
                    <PhoneCall className="h-4 w-4" />
