  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="absolute left-3 top-3 inline-flex h-8 w-8 items-center justify-center rounded-md bg-white/86 text-text shadow-[0_8px_20px_-14px_rgba(15,23,42,0.18)]">
        ...
        {post?.coverUrl ? (
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="text-center">
              <div className="mx-auto inline-flex h-14 w-14 items-center justify-center rounded-md bg-white/78 text-text shadow-[0_18px_34px_-20px_rgba(15,23,42,0.18)]">
          ...
          {surface.loading && !posts.length ? (
            ...
            <div className="flex min-h-[300px] items-center justify-center">
              <div className="max-w-[320px] text-center">
                <div className="mx-auto inline-flex h-12 w-12 items-center justify-center rounded-md bg-surface-subtle text-text-subtle">
              ...
              <div className="border-b border-line-soft xl:border-b-0 xl:border-r">
                ...
                <div className="px-5 py-5 md:px-6">
                  <div className="flex items-center gap-3">
                    <div className="inline-flex h-9 w-9 items-center justify-center rounded-md bg-surface-subtle text-text">
                      <PlatformGlyph
