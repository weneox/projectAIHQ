...
function SettingSwitch({ checked, onChange, disabled = false }) {
  return (
    <button
      ...
      className={cx(
        "relative inline-flex h-7 w-12 shrink-0 items-center rounded-md transition-colors duration-base ease-premium disabled:cursor-not-allowed disabled:opacity-60",
    ...
    >
      <span
        className={cx(
          "inline-block h-5 w-5 rounded-md bg-white shadow-sm transition-transform duration-base ease-premium",
