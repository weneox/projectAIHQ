  ...
  return (
    ...
    >
      <div className="flex flex-wrap items-center gap-3">
        ...
        {item?.kind ? (
          <span className={`inline-flex rounded-md px-2.5 py-1 text-[11px] font-medium ${tone.pill}`}>
            {tone.label}
          </span>
        ) : null}
      </div>
      ...
      <div className="space-y-8">
        ...
        >
          ...
          <div className="flex flex-wrap gap-3 pt-1">
            <Link
              to="/proposals"
              className="inline-flex items-center rounded-md border border-brand/15 bg-brand-soft px-4 py-2 text-sm font-medium text-brand transition hover:border-brand/25 hover:bg-brand-soft"
            >
              Open proposal details
            </Link>
            <Link
              to="/comments"
              className="inline-flex items-center rounded-md border border-line bg-surface px-4 py-2 text-sm font-medium text-text-muted transition hover:border-line-strong hover:bg-white hover:text-text"
            >
