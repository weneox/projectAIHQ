...
import Input, { Select as UiSelect } from "../components/ui/Input.jsx";
...
function Field({ icon: Icon, className = "", ...props }) {
  return (
    <Input
      ...
      appearance="quiet"
      className={className}
      leftIcon={Icon ? <Icon className="h-4 w-4" strokeWidth={2.1} /> : undefined}
    />
  );
}

function Select({ className = "", ...props }) {
  return <UiSelect {...props} appearance="quiet" className={className} />;
}
