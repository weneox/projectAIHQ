  ...
  return (
    <div className="flex flex-col gap-4 border-b border-line-soft px-5 py-5 lg:flex-row lg:items-center lg:justify-between">
      <div className="min-w-0">
        ...
        <div className="mt-3 flex flex-wrap gap-2">
          <button
            ...
            className="inline-flex h-8 items-center rounded-md bg-surface-subtle px-3 text-[12px] font-semibold text-text-muted transition-colors hover:text-text"
          >
            Open Business Info
          </button>
          <button
      ...
      <div className="flex shrink-0 items-center gap-2">
        <span className="inline-flex h-9 items-center gap-2 rounded-md bg-surface-subtle px-3 text-[12px] font-semibold text-text-muted">
          <span className="h-1.5 w-1.5 rounded-md bg-[rgb(var(--color-text-soft))]" />
          {readyLabel}
        </span>

        {activeLane ? (
          <span
            className="inline-flex h-9 items-center gap-2 rounded-md bg-success-soft px-3 text-[12px] font-semibold text-success"
            title={activeLane}
          >
    ...
    <div className="flex min-h-[230px] flex-col px-5 py-5">
        ...
        <div className="flex min-w-0 items-center gap-4">
          ...
          <div className="min-w-0">
            ...
            <div className={cx("mt-1 flex items-center gap-2 text-[12px] font-semibold", textClass(status.tone))}>
              <span className={cx("h-1.5 w-1.5 rounded-md", dotClass(status.tone))} />
              {status.label}
            </div>
          </div>
        </div>
      ...
      <div className="mt-auto flex items-center justify-between gap-3 pt-5">
        <button
          ...
          className="inline-flex h-9 items-center gap-1.5 rounded-md px-2 text-[13px] font-semibold text-brand transition-colors duration-base ease-premium hover:bg-brand-soft"
        >
          Details
