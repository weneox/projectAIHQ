      ...
      <div className="grid gap-6 xl:grid-cols-[380px_minmax(0,1fr)]">
        <section className="space-y-5">
          ...
          <Card className="p-5">
            ...
            <div className="max-h-[620px] space-y-2 overflow-auto pr-1">
              {surface.loading ? (
                <div className="rounded-md border border-line bg-surface-muted p-4 text-sm text-text-muted">
                  Loading tenants...
                </div>
              ) : filtered.length ? (
                filtered.map((tenant) => {
                ...
                <div className="rounded-md border border-dashed border-line bg-surface-muted p-4 text-sm text-text-muted">
        ...
        <section className="space-y-5">
          <Card className="p-6">
            ...
            {!selected ? (
              <div className="rounded-md border border-dashed border-line bg-surface-muted p-5 text-sm text-text-muted">
