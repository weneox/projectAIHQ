  ...
  return (
    ...
    >
      ...
      <div className="relative flex items-start gap-4">
        <div className="mt-0.5 flex h-11 w-11 shrink-0 items-center justify-center rounded-md border border-line bg-white text-text shadow-[inset_0_1px_0_rgba(255,255,255,0.72)]">
          {icon}
        </div>
          ...
          <SurfaceMessage
            ...
            action={
              <button
                ...
                className="inline-flex items-center gap-2 rounded-md bg-white/[0.06] px-4 py-2 text-[13px] font-medium text-white shadow-[inset_0_1px_0_rgba(255,255,255,0.04)] transition hover:bg-white/[0.09]"
              >
                Retry refresh
          ...
          <SurfaceMessage
            ...
            action={
              <div className="flex flex-wrap items-center gap-2">
                <div className="inline-flex items-center gap-2 rounded-md bg-white/[0.05] px-3 py-2 text-[12px] text-white/62 shadow-[inset_0_1px_0_rgba(255,255,255,0.04)]">
