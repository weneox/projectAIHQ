        ...
        <div className="flex items-start justify-between gap-3">
          <div className="min-w-0">
            <div className="flex items-center gap-2.5">
              <span
                className={cn(
                  "mt-[1px] h-2.5 w-2.5 shrink-0 rounded-md",
                  accent.orb,
                  accent.orbGlow
                )}
              />
          ...
          <div className="shrink-0">
            <div
              className={cn(
                "flex items-center justify-center rounded-md border border-white/[0.05] bg-white/[0.02] text-white/34 transition-all duration-200 ease-out group-hover:border-white/[0.08] group-hover:bg-white/[0.035] group-hover:text-white/70",
                sizeClasses.arrow
              )}
            >
