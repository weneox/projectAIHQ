...
function SurfacePill({ children, className = "" }) {
  return (
    <span
      className={cn(
        "inline-flex items-center rounded-md border border-white/[0.055] bg-[linear-gradient(180deg,rgba(255,255,255,0.035),rgba(255,255,255,0.02))] px-2.5 py-1 text-[11px] text-white/54",
        "transition-[background,border-color,color] duration-200",
        className
      )}
    >
