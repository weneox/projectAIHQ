...
export default function ProposalExpanded({
  ...
  return (
    ...
    >
                  ...
                  {tabs.map((t) => {
                    ...
                    return (
                      <button
                        ...
                        className={cn(
                          "rounded-md border px-3.5 py-2 text-[12px] font-medium transition",
                          active
      ...
      textClassName="mt-2 w-full rounded-[20px] border border-white/[0.08] bg-white/[0.04] p-3 text-[13px] text-white outline-none placeholder:text-white/24 transition focus:border-cyan-300/20 focus:bg-white/[0.055]"
            ...
            <div className="min-w-0 space-y-5">
              <DetailSection title="Overview">
                ...
                <div className="mt-5">
                  <span className={cn("block h-[4px] w-14 rounded-md", tone.rail)} />
                </div>
              </DetailSection>
                ...
                <div className="flex flex-wrap gap-2">
                  {hashtags.length ? (
                    hashtags.slice(0, 36).map((tag, i) => (
                      <span
                        key={`${tag}_${i}`}
                        className="rounded-md border border-white/[0.06] bg-white/[0.04] px-2.5 py-1 text-[11px] text-white/68"
                      >
                        {tag}
                      </span>
                    ))
