  ...
  return (
    <div className="rounded-[24px] bg-white/[0.025] px-4 py-4 shadow-[inset_0_1px_0_rgba(255,255,255,0.025)]">
      <div className="flex items-center gap-2">
        <span className={cn("h-2 w-2 rounded-md", tone.dot)} />
      ...
      <section className="relative overflow-hidden rounded-[34px] bg-[linear-gradient(180deg,rgba(5,10,20,0.94),rgba(3,8,16,0.88))] px-5 py-5 shadow-[0_26px_100px_rgba(0,0,0,0.28),inset_0_1px_0_rgba(255,255,255,0.03)] backdrop-blur-2xl md:px-7 md:py-6">
        ...
        <div className="relative flex flex-col gap-6">
          <div className="grid gap-5 xl:grid-cols-[minmax(0,1.2fr)_430px] xl:items-start">
            <div className="min-w-0">
              <div className="flex flex-wrap items-center gap-3">
                ...
                <div className="inline-flex items-center gap-2 rounded-md bg-white/[0.045] px-3 py-1.5 text-[11px] font-medium text-white/68 shadow-[inset_0_1px_0_rgba(255,255,255,0.03)]">
                  <span className="h-1.5 w-1.5 rounded-md bg-cyan-300/90 shadow-[0_0_10px_rgba(34,211,238,0.75)]" />
          ...
          <div className="rounded-[28px] bg-white/[0.02] p-3 shadow-[inset_0_1px_0_rgba(255,255,255,0.025)] md:p-4">
            <div className="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
                ...
                {tabs.map((tab) => {
                  ...
                  return (
                    <button
                      ...
                      className={cn(
                        "inline-flex items-center gap-2 rounded-md px-4 py-2.5 text-[13px] font-medium transition-all duration-200",
                        active
              ...
              <div className="flex w-full flex-col gap-3 xl:w-auto xl:min-w-[580px] xl:flex-row xl:items-center xl:justify-end">
                <div className="flex flex-wrap items-center gap-2">
                  <div className="inline-flex h-11 items-center gap-2 rounded-md bg-white/[0.04] px-4 text-[12px] text-white/66 shadow-[inset_0_1px_0_rgba(255,255,255,0.03)]">
                    <span className={cn("h-2 w-2 rounded-md", stageTone(status).dot)} />
                  ...
                  <div className="inline-flex h-11 items-center gap-2 rounded-md bg-white/[0.04] px-4 text-[12px] text-white/58 shadow-[inset_0_1px_0_rgba(255,255,255,0.03)]">
                  ...
                  <button
                    type="button"
                    onClick={onRefresh}
                    className="inline-flex h-11 w-11 items-center justify-center rounded-md bg-white/[0.04] text-white/56 shadow-[inset_0_1px_0_rgba(255,255,255,0.03)] transition hover:bg-white/[0.065] hover:text-white"
                ...
                <label className="group relative block w-full xl:w-[360px]">
                  ...
                  <input
                    ...
                    className="h-12 w-full rounded-md bg-white/[0.045] pl-11 pr-4 text-[14px] text-white placeholder:text-white/24 outline-none transition focus:bg-white/[0.06]"
                  />
                </label>
              </div>
            </div>
            ...
            {toast ? (
              <div className="mt-3 inline-flex items-center gap-2 rounded-md bg-white/[0.04] px-3 py-2 text-[12px] text-white/64 shadow-[inset_0_1px_0_rgba(255,255,255,0.03)]">
            ...
            {status === "draft" ? (
              <div className="mt-3 flex flex-wrap items-center gap-2 text-[12px] text-white/60">
                <div className="inline-flex items-center gap-2 rounded-md bg-white/[0.04] px-3 py-2 shadow-[inset_0_1px_0_rgba(255,255,255,0.03)]">
