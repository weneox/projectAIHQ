    ...
    >
      <div className="rounded-[20px] rounded-bl-[10px] border border-[rgba(15,23,42,0.06)] bg-[linear-gradient(180deg,rgba(255,255,255,0.98),rgba(249,250,251,0.98))] px-4 py-3 shadow-[0_10px_28px_rgba(15,23,42,0.05)]">
        <div className="flex items-center gap-1.5">
          <span className="h-1.5 w-1.5 rounded-md bg-slate-400 animate-pulse" />
          <span className="h-1.5 w-1.5 rounded-md bg-slate-400 animate-pulse [animation-delay:120ms]" />
          <span className="h-1.5 w-1.5 rounded-md bg-slate-400 animate-pulse [animation-delay:240ms]" />
        </div>
      </div>
    </motion.div>
  );
  ...
  return (
    <div className="grid grid-cols-[14px_minmax(0,1fr)] gap-3">
      <div className="relative flex justify-center">
        <div className={`mt-1 h-2.5 w-2.5 rounded-md ${accent.dot}`} />
...
function Composer({
  ...
  return (
    <div className="bg-transparent px-5 pb-5 pt-3">
      ...
      textClassName="min-h-[84px] flex-1 resize-none appearance-none border-0 bg-transparent px-1 py-1.5 text-[14px] leading-[1.68] tracking-[-0.01em] text-text shadow-none outline-none ring-0 placeholder:text-text-subtle focus:border-0 focus:outline-none focus:ring-0 focus-visible:outline-none focus-visible:ring-0"
