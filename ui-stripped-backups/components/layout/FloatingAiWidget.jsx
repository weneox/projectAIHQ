            ...
            <div className="flex items-center justify-between border-b border-[rgba(15,23,42,0.08)] px-6 py-4">
              <div className="flex items-center gap-3">
                ...
                {canReset ? (
                  <button
                    ...
                    className="inline-flex h-8 items-center gap-1.5 rounded-md px-2.5 text-[11px] font-medium text-text-muted transition-colors hover:bg-[rgba(15,23,42,0.04)] hover:text-text disabled:cursor-not-allowed disabled:opacity-45"
                  >
              ...
              {!pageMode ? (
                <button
                  type="button"
                  onClick={() => onOpenChange?.(false)}
                  className="inline-flex h-9 w-9 items-center justify-center rounded-md text-text-muted transition-colors hover:bg-[rgba(15,23,42,0.04)] hover:text-text"
                  aria-label="Close setup"
                >
