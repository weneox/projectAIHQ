  ...
  return (
    ...
    >
      <div className="flex items-start gap-3">
        <span className="inline-flex h-9 w-9 shrink-0 items-center justify-center rounded-md bg-surface-subtle text-[13px] font-semibold tracking-[-0.02em] text-text">
          {initial(item.author)}
        </span>
