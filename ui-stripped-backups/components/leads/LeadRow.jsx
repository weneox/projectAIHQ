      ...
      <div className="grid gap-4 xl:grid-cols-[1.25fr_0.9fr_1fr_0.8fr_0.8fr_0.7fr] xl:items-center">
        <div className="min-w-0">
          <div className="flex items-center gap-2">
            <div
              className={`flex h-6 w-6 items-center justify-center rounded-md border ${sourceTone(
                lead
              )}`}
            >
              {channelIconNode}
        ...
        <div>
          <span
            className={`inline-flex rounded-md border px-2.5 py-1 text-[10px] font-medium uppercase tracking-[0.16em] ${stageTone(
              stage
            )}`}
          >
            {stage}
        ...
        <div>
          <span
            className={`inline-flex rounded-md border px-2.5 py-1 text-[10px] font-medium uppercase tracking-[0.16em] ${statusTone(
              status
            )}`}
          >
            {status}
