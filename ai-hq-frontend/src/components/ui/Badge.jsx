...
const TONES = {
  ...
  success: {
    ...
    subtle: "border-success/20 bg-success-soft text-success",
    outline: "border-success/20 text-success",
    dot: "bg-success",
  },
  warn: {
    solid: "border-warning bg-warning text-white",
    subtle: "border-warning/20 bg-warning-soft text-warning",
    outline: "border-warning/20 text-warning",
    dot: "bg-warning",
  },
  danger: {
    solid: "border-danger bg-danger text-white",
    subtle: "border-danger/20 bg-danger-soft text-danger",
    outline: "border-danger/20 text-danger",
    dot: "bg-danger",
  },
  info: {
    solid: "border-info bg-info text-white",
    subtle: "border-info/20 bg-info-soft text-info",
    outline: "border-info/20 text-info",
    dot: "bg-info",
  },
};
