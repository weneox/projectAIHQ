...
function SparkTooltip({ active, payload, label }) {
  ...
  return (
    <div className="rounded-xl border border-[#DDE8F3] bg-white/95 px-3 py-2 shadow-[0_18px_44px_-28px_rgba(15,23,42,0.55)] backdrop-blur">
        ...
        {items.map((item) => {
          ...
          return (
            ...
            >
              ...
              <div className="pointer-events-none absolute -right-10 -top-12 h-28 w-28 rounded-full bg-[#14B8A6]/[0.045] blur-2xl" />
              ...
              <div className="flex items-start justify-between gap-3">
                ...
                <span className="rounded-full border border-[#CDEFE9] bg-[#F0FDFA] px-2.5 py-1 text-[10.5px] font-semibold text-[#0F766E] shadow-[0_1px_2px_rgba(20,184,166,0.08)]">
                  {item.badge}
                </span>
              </div>
