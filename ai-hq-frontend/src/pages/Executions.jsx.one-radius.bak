    ...
    <AdminPageShell
      ...
      actions={
        <button
          ...
          className="inline-flex h-11 items-center gap-2 rounded-2xl border border-line bg-surface px-4 text-sm text-text transition hover:border-line-strong hover:bg-surface-muted disabled:cursor-not-allowed disabled:opacity-40"
        >
          <RotateCcw
            className={cn(
              "h-4 w-4",
        ...
        <div className="grid gap-3 md:grid-cols-2 xl:grid-cols-4">
          ...
          <label className="space-y-2">
            ...
            <input
              ...
              className="w-full rounded-2xl border border-line bg-surface px-4 py-3 text-sm text-text outline-none placeholder:text-text-subtle"
            />
          </label>
        </div>
      </Surface>
  ...
  return (
    <label className="space-y-2">
      ...
      <select
        ...
        className="w-full rounded-2xl border border-line bg-surface px-4 py-3 text-sm text-text outline-none"
      >
        {options.map((option) => (
