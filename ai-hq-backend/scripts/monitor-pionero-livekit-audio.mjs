...
function buildMonitorResult({
  ...
  return {
    ...
    sttFramesDropped: n(sttFramesDropped),
    sttFrameNormalizeFailed: n(sttFrameNormalizeFailed),
    sttPcmBytesBuffered: n(sttPcmBytesBuffered),
    ...
    ...(safeText(llmModel) ? { llmModel: safeText(llmModel) } : {}),
    ...(safeText(llmReasonCode) ? { llmReasonCode: safeText(llmReasonCode) } : {}),
    ...(safeText(llmErrorMessage) ? { llmErrorMessage: safeText(llmErrorMessage) } : {}),
    ...(n(llmHttpStatus) > 0 ? { llmHttpStatus: n(llmHttpStatus) } : {}),
...
function buildResultFromState({
  ...
  return buildMonitorResult({
    ...
    sttFramesDropped: stt.sttFramesDropped,
    sttFrameNormalizeFailed: stt.sttFrameNormalizeFailed,
    sttPcmBytesBuffered: stt.sttPcmBytesBuffered,
    ...
    llmModel: llm.model,
    llmReasonCode: llm.reasonCode,
    llmErrorMessage: llm.errorMessage,
