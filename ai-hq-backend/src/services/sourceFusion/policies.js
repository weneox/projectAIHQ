...
const SOURCE_PROFILES = {
  manual: {
    ...
    weight: 1.0,
    trustClass: "manual",
    trustTier: "admin_confirmed",
    trustLabel: "manually_confirmed",
    trustScore: 0.99,
    weak: false,
  },
  website: {
  ...
  google_business_profile: {
    ...
    trustTier: "trusted_enrichment",
    trustLabel: "structured_trusted_enrichment",
    trustScore: 0.84,
    weak: false,
  },
  google_places: {
  ...
  whatsapp_business: {
    ...
    trustTier: "connected_official_provider",
    trustLabel: "connected_official_provider_data",
    trustScore: 0.88,
    weak: false,
  },
  instagram: {
  ...
  google_maps: {
    ...
    trustLabel: "weak_inferred_scrape",
    trustScore: 0.42,
    weak: true,
  },
  default: {
    ...
    trustClass: "unknown",
    trustTier: "unknown",
    trustLabel: "unclassified_source",
    trustScore: 0.6,
    weak: false,
  },
};
