  ...
  const run = async (cx) => {
    ...
    await insertSetupReviewEvent(cx, {
      ...
      payload: {
        ...
        runtimeProjectionFresh: runtimeProjectionFreshness ? !obj(runtimeProjectionFreshness).stale : null,
        runtimeProjectionFreshnessReasons: arr(obj(runtimeProjectionFreshness).reasons),
