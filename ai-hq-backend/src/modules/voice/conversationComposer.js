...
export function buildBrowserVoiceOpeningInstructions({
  ...
  return [
    ...
    "- You may use a natural help phrase such as asking how you can help, but keep it short.",
    "- Do not use a fixed hardcoded script.",
    ...
    "- Opening must be one complete sentence, not a half sentence.",
