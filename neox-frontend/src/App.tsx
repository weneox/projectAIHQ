...
function AdminMagicRedirect({ toLang }: { toLang: Lang }) {
  ...
  return (
    <Navigate to={`/${toLang}/admin/magic${loc.search}${loc.hash}`} replace />
  );
}
  ...
  return (
    <SmoothScrollProvider>
      <Routes>
        ...
        <Route
          path="/admin/magic"
          element={<AdminMagicRedirect toLang={rootLang} />}
        />
        <Route
          path="/admin"
          element={<Navigate to={`/${rootLang}/admin`} replace />}
        />
        <Route
          path="/admin/*"
          element={<Navigate to={`/${rootLang}/admin`} replace />}
