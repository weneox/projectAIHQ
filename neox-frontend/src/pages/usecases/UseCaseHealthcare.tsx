 ...
 *  ✅ imageGate: sözlər bitənə qədər şəkil görünməsin, arxa planda yüklənsin
 */
function FullSplitSection({
  ...
  // ✅ şəkil “daxildə” yüklənir, amma gate açılana qədər ekranda görünmür
  ...
  useEffect(() => {
    ...
    // real şəkli arxa planda yüklət (hero üçün daha tez)
    const i = new Image();
    i.decoding = "async";
  ...
  return (
    ...
    >
      ...
      {/* IMAGE SIDE:
          - right side boş qalmır: placeholder gradient var
          - gate açılınca, şəkil hazırdırsa yumşaq fade-in */}
...
export default memo(function UseCaseHealthcare() {
  ...
  const showMeta = revealCount >= 5; // ✅ “bitdi” momenti
  ...
  // images
  const BG_1 =
    "https://res.cloudinary.com/dppoomunj/image/upload/v1771210032/sandjaya-ai-generated-8999615_1920_r8uyxk.jpg";
  const BG_2 =
    "https://res.cloudinary.com/dppoomunj/image/upload/v1771207439/geralt-research-7116736_1920_qrubzu.jpg";
  const BG_3 =
    "https://res.cloudinary.com/dppoomunj/image/upload/v1771207440/geralt-network-4109223_1920_qxv3x1.jpg";
  const BG_4 =
    "https://res.cloudinary.com/dppoomunj/image/upload/v1771212220/publicdomainpictures-bacteria-163711_1920_p1jra4.jpg";

  // ✅ səhifəyə girən kimi şəkillər “daxildə” yüklənsin (amma hero gate açılana qədər görünməyəcək)
  useEffect(() => {
  ...
  const t = useMemo(() => {
    return {
      cta1: lang === "az" ? "Klinikaya uyğunlaşdır" : "Adapt",
      cta2: lang === "az" ? "Xidmətlər" : "Services",
      s1: {
        eyebrow: "USE CASE • HEALTHCARE",
        title: "Healthcare senarisi",
        lead: "Pasiyent yazır → sistem niyyəti anlayır → doğru addımı verir.",
        bullets: ["WhatsApp / IG / sayt — eyni axın.", "Diaqnoz yox: yönləndirmə + randevu.", "Hər addım ölçülür."],
        chips: [
          { icon: HeartPulse, label: "Sorğu" },
          { icon: ScanSearch, label: "Triage" },
          { icon: CalendarCheck2, label: "Booking" },
          { icon: LineChart, label: "KPI" },
        ],
      },
      s2: {
        eyebrow: "SCENARIO 01 • TRIAGE",
        title: "Sadə triage",
        lead: "2–3 sual → routing → CTA.",
        bullets: ["“Randevu” → 1 klik booking.", "“Qiymət/xidmət” → kataloq + next-step.", "Həssas mövzu → operator."],
        chips: [
  ...
  return (
    <main ref={rootRef as any} className="fsRoot">
      <style>{`
        ...
        /* placeholder: gate bağlı olanda da sağ tərəf boş görünmür */
        .fs-imgPh{
        ...
        /* ✅ yalnız gate açılıb + imgReady olanda görünür */
        .fs-img.is-show .fs-imgEl{ opacity: 1; }

        /* optional: şəkil gələndə placeholder bir az yumşaq azalsın */
      ...
      {/* HERO:
          ✅ imageGate={showMeta} => sözlər bitənə qədər şəkil görünmür
          (amma arxa planda yüklənir) */}
      <FullSplitSection
        hero
      ...
      {/* Other sections: imageGate default true => normal görünür */}
      <FullSplitSection
        flip
        imgUrl={BG_2}
        imgPos="center"
