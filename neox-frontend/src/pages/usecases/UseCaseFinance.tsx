...
/** Cloudinary helpers: smaller/faster + preload */
 ...
 *  ✅ imageGate: words finish -> then image fades in (preloaded + placeholder)
 */
function FullSplitSection({
  ...
  return (
    ...
    >
      ...
      {/* ✅ right side: placeholder immediately, real image only after gate opens */}
...
export default memo(function UseCaseFinance() {
  ...
  // SƏNİN 4 ŞƏKİL
  const BG_1 =
    "https://res.cloudinary.com/dppoomunj/image/upload/v1771224252/sergeitokmakov-stock-trading-6525084_1920_gavhf0.jpg";
  const BG_2 =
    "https://res.cloudinary.com/dppoomunj/image/upload/v1771224198/theinvestorpost-man-5782412_1920_cj4clc.jpg";
  const BG_3 = "https://res.cloudinary.com/dppoomunj/image/upload/v1771224194/27707-laptop-1205256_1920_h74t3g.jpg";
  const BG_4 =
    "https://res.cloudinary.com/dppoomunj/image/upload/v1771222802/eivindpedersen-bitcoin-3327922_1920_bd4rxt.jpg";

  // ✅ preload (hero + rest) — gec açılma hissini öldürür
  useEffect(() => {
  ...
  const t = useMemo(() => {
    return {
      cta1: lang === "az" ? "Məsləhət al" : "Get advice",
      cta2: lang === "az" ? "Xidmətlər" : "Services",
      s1: {
        eyebrow: "FINANCE • MARKET",
        title: "Finance senarisi",
        lead: "Maliyyə qərarları üçün sürətli analiz və yönləndirmə.",
        bullets: ["Realtime bazar məlumatı.", "Risk/Reward hesablama.", "İnteqrasiya olunmuş portfel göstəriciləri."],
        chips: [
          { icon: CalendarCheck2, label: "Realtime" },
          { icon: LineChart, label: "Analytics" },
          { icon: ClipboardList, label: "Strategy" },
          { icon: ShieldCheck, label: "Trust" },
        ],
      },
      s2: {
        eyebrow: "SCENARIO 01 • TRADING",
        title: "Market trading",
        lead: "Canlı qiymət və müxtəlif bazar əməliyyatları.",
        bullets: ["Çoxlu aktivlərlə ticarət seçimi.", "Leveraj və limit profilləri.", "İnteqrasiya edilmiş risk idarəetməsi."],
        chips: [
          { icon: ScanSearch, label: "Market Scan" },
          { icon: CalendarCheck2, label: "Order Flow" },
          { icon: LineChart, label: "Smart Tools" },
  ...
  return (
    <main ref={rootRef as any} className="fsRoot">
      ...
      {/* ✅ HERO: sözlər bitəndən sonra şəkil yumşaq gəlir */}
      <FullSplitSection
        hero
